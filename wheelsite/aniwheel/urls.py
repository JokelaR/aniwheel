...
urlpatterns = [
    ...
    path("api/anime/random", views.get_random_anime, name="get_random_anime"),
    path("api/anime/more_random", views.get_more_anime, name="get_more_anime"),
    path("api/anime/set_seen", views.add_anime_to_seen, name="add_anime_to_seen"),
